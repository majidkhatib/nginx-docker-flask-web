...
! function() {
    ...
    var e = window.document,
        ...
        s = function(e, o) { for (var t = 0, r = e.length; t < r; t++) o(e[t]) },
        u = function(e) {
            return function(o, t, r) {
                ...
                return null != r && s(r, (function(o) { a.appendChild("string" == typeof o ? e.createTextNode(o) : o) })), a
            }
        },
        h = u(e),
        g = function(e) { var o; return function() { o || (o = 1, e.apply(this, arguments)) } },
        f = function(e, o) { return {}.hasOwnProperty.call(e, o) },
        ...
        A = function(e, o) {
            var t = M[e] || (M[e] = []);
            if (!(t.push(o) > 1)) {
                var r = g((function() { for (delete M[e]; o = t.shift();) o.apply(null, arguments) }));
                if (l) {
                    var n = new a;
                    ...
                    var c = u(i.document)("script", { async: !0, src: e + (-1 !== e.indexOf("?") ? "&" : "?") + "callback=_" }),
        ...
        F = function(e, o, t) {
            ...
            if (((s === c || s === "gist." + c) && "archive" === h[3] || s === c && "releases" === h[3] && ("download" === h[4] || "latest" === h[4] && "download" === h[5]) || s === "codeload." + c) && (l.target = "_top"), "true" === b(o["data-show-count"]) && s === c && "marketplace" !== h[1] && "sponsors" !== h[1] && "orgs" !== h[1] && "users" !== h[1] && "-" !== h[1]) {
                ...
                A.call(this, "https://api.github.com" + v, (function(e, o) {
                    if (!e) {
                        var a = o[m];
                        d.appendChild(r("a", { className: "social-count", href: o.html_url + g, rel: "noopener", target: "_blank", "aria-label": a + " " + m.replace(/_count$/, "").replace("_", " ").slice(0, a < 2 ? -1 : void 0) + " on GitHub" }, [("" + a).replace(/\B(?=(\d{3})+(?!\d))/g, ",")]))
                    }
                    t(d)
                }))
            } else t(d)
        ...
        G = function(o, r) {
            if (null != o && null != r)
                if (o.getAttribute && (o = function(e) {
                    ...
                    var a = h("span");
                    F(a.attachShadow({ mode: "closed" }), o, (function() { r(a) }))
                } else {
                    var n = h("iframe", { src: "javascript:0", title: o.title || void 0, allowtransparency: !0, scrolling: "no", frameBorder: 0 });
                    ...
                    var c = function() {
                        ...
                        v(n, "load", c), F.call(l, a, o, (function(e) {
                            ...
                            n.parentNode.removeChild(n), w(n, "load", (function() { E(n, a) })), n.src = i + "#" + (n.name = function(e, o, t, r) {
